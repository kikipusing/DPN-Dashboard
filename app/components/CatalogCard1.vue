    ...
    <template #header>
      ...
      >
        <div class="flex items-center justify-between">
          <div>
            <h2 class="text-white text-2xl font-bold">Kependudukan</h2>
            <p class="text-blue-100 text-sm mt-1">Data Demografi</p>
          </div>
          <div class="bg-white bg-opacity-20 p-3 rounded-lg">
            <UIcon name="i-heroicons-users" class="w-8 h-8 text-black" />
          </div>
        </div>
      </div>
    </template>
    ...
    <div class="p-6">
      ...
      <div class="grid grid-cols-2 gap-3 mb-4">
        ...
        <div class="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg">
          <p class="text-gray-500 dark:text-gray-400 text-xs mb-1">Kepadatan</p>
          <p class="text-gray-800 dark:text-gray-200 text-xl font-bold">
            145/km²
          </p>
        </div>
