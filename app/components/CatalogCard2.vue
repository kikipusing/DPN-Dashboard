  ...
  >
    <template #header>
      ...
      >
        <div class="flex items-center justify-between">
          <div>
            <h2 class="text-white text-2xl font-bold">Sosial Ekonomi</h2>
            <p class="text-green-100 text-sm mt-1">Indikator Ekonomi</p>
          </div>
    ...
    <div class="p-6">
      <p class="text-gray-600 dark:text-gray-400 mb-4 text-sm">
        Data ekonomi, pendapatan, kemiskinan, dan kesejahteraan masyarakat
        Indonesia
      </p>
      ...
      <div class="grid grid-cols-2 gap-3 mb-4">
        ...
        <div class="bg-orange-50 dark:bg-orange-900/20 p-4 rounded-lg">
          ...
          <p class="text-orange-600 dark:text-orange-400 text-xl font-bold">
            5.32%
          </p>
        </div>
        ...
        <div class="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg">
          <p class="text-gray-500 dark:text-gray-400 text-xs mb-1">Inflasi</p>
          <p class="text-gray-800 dark:text-gray-200 text-xl font-bold">
            2.61%
          </p>
        </div>
